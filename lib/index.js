(function() {
  var DEP_ID_SUFFIX_REGEXP, EOL, Q, UglifyJS, amdDependency, async, coffee, coffeeReactTransform, fs, gutil, logErr, mkdirp, mt2amd, path, reactTools, through, traceur, _, _findVendor, _findVendorInDir, _venderFoundMap;
  ...
  _findVendorInDir = function(inDir, outDir, name, opt, callback) {
    var content, err, mainMapped, mainPath, minifyJS, moduleDir, outPath, outPathExists, packageObj, packagePath, _ref;
