(function() {
  var EOL, Q, amdDependency, async, coffee, coffeeReactTransform, fixDefineParams, getBodyDeps, getUnixStylePath, gutil, jsxTransform, mt2amd, path, through;
  ...
  fixDefineParams = function(def, depId, userDefinedBaseDir) {
    ...
    if (!/(^|[^.]+?)\bdefine\s*\(/.test(def.def) && /(^|[^.]+?)\bmodule\.exports\s*=[^=]/.test(def.def)) {
