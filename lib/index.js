(function() {
  var EOL, Q, UglifyJS, amdDependency, async, coffee, coffeeReactTransform, fs, gutil, logErr, mkdirp, mt2amd, path, reactTools, through, _findVendor, _findVendorInDir, _venderFoundMap;
