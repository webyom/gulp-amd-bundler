(function() {
  var CleanCSS, DEP_ID_SUFFIX_REGEXP, EOL, EXPORTS_REGEXP, Q, UglifyJS, _, _bowerDir, _npmDir, _venderFoundMap, amdDependency, async, child_process, coffee, coffeeReactTransform, findVendor, findVendorInDir, fixBowerDir, fixDefineParams, fs, getBodyDeps, getUnixStylePath, gutil, logErr, mkdirp, mt2amd, path, through;
